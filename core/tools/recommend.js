...
export const tools = [
  {
    ...
    handler: async (args) => handleGetFavoriteFriendsLocations(args)
  },
  {
    "name": "recommend_join",
    ...
    handler: async (args) => handleRecommendJoin(args)
  },
  {
    ...
    handler: async (args) => handleSetJoinPreference(args)
  },
  {
    ...
    handler: async (args) => handleGetJoinPreference(args)
  },
  {
    ...
    handler: async (args) => handleRecordJoinChoice(args)
  },
  {
    ...
    handler: async (args) => handleGetJoinLearning(args)
  }
];
